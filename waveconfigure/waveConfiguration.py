...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        Label(self, text='type: ').grid(row=0, column=4, sticky=W)
        self.type_ent = Entry(self)
        self.type_ent.grid(row=0, column=5, sticky=W)
    ...
    def compute(self):
        ...
        self.type = self.type_ent.get().upper()
    ...
    def format(self):
        ...
        json += '  "period": {{"init": {}, "rate": {}, "type": "{}"}},\n'.format(self.period.init,
                                                                                 self.period.get_rate(self.end_wave,
                                                                                                      self.des_wave),
                                                                                 self.period.type)

        json += '  "delay": {{"init": {}, "rate": {}, "type": "{}"}}\n}}'.format(self.delay.init,
                                                                                 self.delay.get_rate(self.end_wave,
                                                                                                     self.des_wave),
                                                                                 self.delay.type)
